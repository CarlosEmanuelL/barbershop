        ...
        binding.btAgendar.setOnClickListener{
            ...
            when{
                ...
                hora < "8:00" && hora > "19:00" -> {
                    mensagem(it, "Barber Shop esta fechado - horario de atendimento das 08:00 as 19:00!","#FF0000")
                }
                data.isEmpty() -> {
                    mensagem(it, "Coloque uma data!", "#FF0000")
                }
                barbeiro1.isChecked && data.isNotEmpty() -> {
                    salvarAgendamento(it, nome, "Pedro da Silva",data, hora)
                }
                barbeiro2.isChecked && data.isNotEmpty() -> {
                    salvarAgendamento(it, nome, "Marcos Duarte Gomes",data,hora)
                }
                barbeiro3.isChecked && data.isNotEmpty() -> {
